    ...
    <div style={{ minHeight: '80vh', padding: '6rem 1rem 4rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div className="el-card" style={{ width: '100%', maxWidth: '450px', padding: '3rem 2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <Zap size={48} className="text-primary" style={{ margin: '0 auto 1rem' }} />
          <h1 className="heading-md">Регистрация</h1>
          <p className="text-secondary">Начните автоматизировать свою прибыль уже сегодня.</p>
        </div>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <button disabled={loading} type="submit" className="btn btn-accent" style={{ width: '100%', padding: '1rem', marginTop: '1rem' }}>
            {loading ? 'Реєстрація...' : 'Зарегистрироваться'}
          </button>
        </form>
